...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('View PDF'), array('action' => 'view', 'ext'=>'pdf',$user['User']['id'],'show')); ?> </li>
		<li><?php echo $this->Html->link(__('Download PDF'), array('action' => 'view', 'ext'=>'pdf',$user['User']['id'],'download')); ?> </li>
