...
if (file_exists(DOMPDF_DIR . "/dompdf_config.mzm.inc.php")) {
    require_once(DOMPDF_DIR . "/dompdf_config.mzm.inc.php");
}
 ...
 */
def("DOMPDF_ADMIN_USERNAME", "use1r");
def("DOMPDF_ADMIN_PASSWORD", "passwor1d");
...
if (DOMPDF_ENABLE_AUTOLOAD) {
    ...
    //require_once(DOMPDF_LIB_DIR . "/php-font-lib/FontLib/Font.php");
}
